...
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/samsung/callisto/recovery/recovery_keys.c
BOARD_CUSTOM_GRAPHICS := ../../../device/samsung/callisto/recovery/graphics.c
TARGET_RECOVERY_FSTAB := device/samsung/callisto/ramdisk/root/fstab.msm7x27
